# Gateway configuration reference — implemented schema v1 baseline

> **Status:** this file documents the configuration currently implemented
> before the architecture rework approved on 2026-07-31. The incompatible
> target schema is documented in [`CONFIGURATION.md`](CONFIGURATION.md), and
> the migration order is defined in
