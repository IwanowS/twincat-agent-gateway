# Архитектура TwinCAT Agent Gateway — реализованный baseline v1

> **Статус:** историческое описание реализованного до 2026-07-31 MVP.
> Целевая несовместимая архитектура описана в
> [`ARCHITECTURE.md`](ARCHITECTURE.md), а порядок перехода — в
> [`ARCHITECTURE_REWORK_PLAN.md`](ARCHITECTURE_REWORK_PLAN.md).
> Этот файл сохраняется как источник проверенных деталей текущей реализации,
> но не определяет новые публичные контракты.
